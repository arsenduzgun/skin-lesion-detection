...
ENV MODEL_PATH=/app/backend/models/HAM10000_efficientnetB0.keras \
    META_PATH=/app/backend/models/HAM10000_meta.json \
...
CMD ["gunicorn", "-w", "2", "-k", "gthread", "-t", "120", "-b", "0.0.0.0:5000", "backend.app:app"]